...
DDCaloHitCreator::Settings::Settings()
    : m_eCalCaloHitCollections(StringVector()), m_hCalCaloHitCollections(StringVector()),
      ...
      m_hCalBarrelOuterR(0.f), m_hCalBarrelOuterPhi0(0.f), m_hCalBarrelOuterSymmetry(0.f),
      m_eCalBarrelNormalVector({0.0, 0.0, 1.0}), m_hCalBarrelNormalVector({0.0, 0.0, 1.0}),
